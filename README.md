...
- `/mines <сумма>` — сапёр: 4×4 клетки, 5 множителей или бомба
- `/rocket <сумма>` — ракета: растущий множитель до краша (нажать «Забрать» вовремя)
...
| `/mines <сумма>` | Сапёр: множители или бомба |
| `/rocket <сумма>` | Ракета: множитель до краша |
