...
DEFAULTS = {
    ...
    # Золотой час: конец текущего окна (0 = выключено); следующий старт — автоматически
    "golden_hour_until": 0.0,
    # Unix time начала следующего окна (0 = задать при первом тике планировщика)
    "golden_hour_next_start": 0.0,
}
